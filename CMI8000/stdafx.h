...
#define MAIN_VERSION	_T("V 3.5.1.0 MEM")
...
typedef struct {
	...
	BOOL	bSortPickFirstAction[2]; //포트 번호가 전이랑 다를때 TRUE
	BOOL	bSortPickFirstNgPass[2];
	int		nSortPickFirstPortNo[2];
	int		nSortPickFirstLotCnt[2];
	int		nSortPickStartedLotCnt[2];
